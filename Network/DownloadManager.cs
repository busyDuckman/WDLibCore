...
//TODO: I have created a much better version of this. Import it.
//I think this code may date back to y2k
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            catch
                            {
                                ...
                                {
                                    data = null;
                                    WDAppLog.logError(ErrorLevel.Error, "Could not load downloaded object",
                                        ex2.Message);
                                }
                            }
                        }
